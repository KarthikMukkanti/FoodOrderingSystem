                    ...
                    <div class="widget widget-cart">
                        ...
                        <div class="order-row bg-white">
                            <div class="widget-body">
                                ...
                                <?php
                                    ...
                                    $est_wt += ($rows["est_time"] * $item["quantity"]);
                                }

                                $est_wt_min = floor($est_wt / 60);
                                $est_wt_sec = $est_wt % 60;
                                ?>
                        ...
                        <div class="widget-body">
                            <div class="price-wrap text-xs-center">
                                ...
                                <br>
                                <p style="margin-bottom: 0px;">Estimated Time: <h4 class="value"><strong><?php if ($est_wt_min < 2) {
                                                                                    echo $est_wt_min . "minute "  . $est_wt_sec . " seconds";
                                                                                } else {
                                                                                    echo $est_wt_min . "minutes "  . $est_wt_sec . " seconds";
                                                                                } ?></strong></h4> </p>
                                <br>
