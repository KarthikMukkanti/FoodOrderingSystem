    ...
    if (empty($_POST['d_name']) || empty($_POST['about']) || $_POST['price'] == '' || $_POST['res_name'] == '' || $_POST['food_cat'] == '' || $_POST['calories'] == '') {
        ...
        if ($extension == 'jpg' || $extension == 'png' || $extension == 'gif' || $extension == 'jpeg') {
            if ($fsize >= 1000000) {
                ...
                $sql = "INSERT INTO dishes(rs_id,title,slogan,price,img,fc_id,calories,est_time) VALUE('" . $_POST['res_name'] . "','" . $_POST['d_name'] . "','" . $_POST['about'] . "','" . $_POST['price'] . "','" . $fnew . "','" . $_POST['food_cat'] . "','" . $_POST['calories'] . "','" . $_POST['est_time'] . "')";
                mysqli_query($db, $sql);
                                    ...
                                    <div class="row p-t-20">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="estimatedTime" class="form-control" placeholder="">
                                            </div>
