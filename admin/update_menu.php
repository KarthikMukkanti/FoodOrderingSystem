    ...
    if (empty($_POST['d_name']) || empty($_POST['about']) || $_POST['price'] == '' || $_POST['res_name'] == '') {
        ...
        if ($extension == 'jpg' || $extension == 'png' || $extension == 'gif' || $extension == 'jpeg') {
            if ($fsize >= 1000000) {
                ...
                $sql = "update dishes set rs_id='$_POST[res_name]',title='$_POST[d_name]',slogan='$_POST[about]',price='$_POST[price]',calories='$_POST[calories]',est_time='$_POST[estimatedTime]',img='$fnew' where d_id='$_GET[menu_upd]'";
                mysqli_query($db, $sql);
                                    ...
                                    <div class="row p-t-20">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="calories" class="form-control" value="<?php echo $roww['calories']; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label">Estimated Time in Sec</label>
                                                <input type="text" name="estimatedTime" class="form-control" value="<?php echo $roww['est_time']; ?>">
                                            </div>
